  ...
  return (
    <article className="prose-article max-w-none pb-20">
      ...
      <HaruBubble label="はるの体験談">
        <p>
          家電量販店で店員さんに聞いたところ、「コンプレッサー式は梅雨〜夏の高温多湿に強く電気代が比較的抑えやすいけれど、冬は除湿力が落ちやすい。デシカント式は電熱ヒーターで乾燥させるので冬でも使えるが、電気代が高くなる傾向があって室温も上がりやすい。購入者の多くは部屋干しの洗濯乾燥が目的ですよ」とのことでした。聞いてみて、方式を季節と使い方で選ぶという感覚が腑に落ちました。
          実際に洗面所（約3畳）を閉め切って家族4人分を「衣類乾燥・強」で運転してみたところ、私の環境では約3〜4時間で厚手のタオルやパーカーのフード裏まで乾きました（乾燥時間は洗濯物の量・素材・室温などの条件で変わります）。生乾き臭も私の環境では気になりませんでした。電気代はコンプレッサー式を毎日4時間使った月に私の感覚で+1,500〜2,000円程度の体感でした。デシカント式はさらに高くなる傾向があると言われており、使い方・機種・電力料金によって大きく変わります。
        </p>
        <p className="mt-2">
          運転音は「強」だとかなり大きく感じて、リビングではテレビの音量を上げたくなりました。夜の寝室近くでは低音が気になりやすく、人のいない洗面所などで使うほうが向いていると感じました。タンクは梅雨の時期に1日2回満水になることもあって、就寝前にセットして朝に確認したら満水停止で半乾きだったこともありました。対応機種ではホースでの連続排水があると便利に感じましたが、機種によって対応・非対応があるので購入前にご確認ください。
        </p>
        <p className="mt-2">
          置き場所については、店頭で見るより家に実際に置くと大きく感じました。コンプレッサー式やハイブリッド式は重め（12〜15kg程度の機種も多い）で、キャスター付きでないと移動がかなり大変に感じました。電源コードも短めで配置場所に少し悩みました。使ってみて気づいたこととしては、夏場にデシカント式をリビングで動かすと室温が上がりやすく冷房と相殺しやすい点、真冬の冷えた洗面所ではコンプレッサー式の除湿力が落ちて乾きにくく感じた点がありました。あくまで私の環境での感想なので、ご自宅の使い方・季節に置き換えて読んでくださいね。
        </p>
      </HaruBubble>

  ...
  return (
    <article className="prose-article max-w-none pb-20">
      ...
      <p>
        ...
        CV-L120個体の断定ではなく、コンプレッサー式の衣類乾燥除湿機全般の注意点として中立にお伝えします。
      </p>
      <ul>
      ...
      <p>
        CV-L120のタンク容量は<strong>4.5L</strong>（仕様値）。連続排水ホースが使える環境ならタンク管理の手間を省けますが、設置場所に排水できる場所があるかを事前に確認しておくと快適に使えます。
      </p>
      ...
      <p>
        CV-L120（コンプレッサー式）で後悔しやすい点は5つ——排熱による室温上昇・タンクの水捨て・運転音・本体サイズ・冬の能力低下です。
        いずれも「コンプレッサー式の特性」として事前に理解しておくことで対策しやすくなります。
      </p>
      <ul>
        <li><strong>梅雨〜夏・北向き・1階の湿気対策が中心</strong>ならコンプレッサー式（CV-L120）</li>
